(function ($) {
	...
	$.fn.inputValueList = function (settings) {
		var config = {
			removeButton: $('<button class="button button--small" type="submit"><svg class="icon icon--mr" aria-hidden="true"><use xlink:href="/project/images/icons/icon.sprite.svg#x-icon"></use></svg> Ta bort</button>')
		};
