...
namespace Appva.Mcss.Admin.Application.Services
{
    ...
    public abstract class AbstractTaskService
    {
        ...
        /// <param name="symbols"></param>
        /// <returns></returns>
        protected Tuple<IList<PrescriptionList>, IList<References>> FindSequencesWithinTimeSpan(string title, DateTime start, DateTime end, Patient patient, IList<Sequence> sequences, IList<Taxon> symbols)
        {
            ...
            foreach (var period in periods)
            {
                ...
                foreach (var sequence in sequences)
                {
                    ...
                    foreach (var executing in ExecutingTimes(period.Start.LocalDateTime, sequence))
                    {
                        ...
                        var reference = references[sequence.Id];
