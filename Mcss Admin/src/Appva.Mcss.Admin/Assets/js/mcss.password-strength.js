...
(function ($) {
    $.fn.PasswordStrength = function (opts) {
        var options = $.extend({ text: language.passwordStrength.label, scores: [language.passwordStrength.veryLow, language.passwordStrength.low, language.passwordStrength.medium, language.passwordStrength.strong, language.passwordStrength.veryStrong], classes: ['very-weak', 'weak', 'medium', 'strong', 'very-strong'] }, opts);
