(function ($) {
	...
	$.fn.collapsableSection = function (settings) {
		...
		this.each(function (index) {
			...
			var button;
			var iconExpand = $('<svg class="icon icon--ml" aria-hidden="true"><use xlink:href="/project/images/icons/icon.sprite.svg#' + config.expandIcon + '-icon"></use></svg>');
			var iconCollapse = $('<svg class="icon icon--ml" aria-hidden="true"><use xlink:href="/project/images/icons/icon.sprite.svg#' + config.collapseIcon + '-icon"></use></svg>');
