// <copyright file="ServerCertificate.cs" company="Appva AB">
...
namespace Appva.Cryptography.X509
{
    ...
    /// </summary>
    public sealed class ServerCertificate : SelfSignedCertificate
    {
        #region Variables.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ServerCertificate"/> class.
        /// </summary>
        /// <param name="signer">The client certificate CA signer</param>
        public ServerCertificate(X509Certificate2 signer)
        {
