...
namespace Appva.Mcss.Domain.Unit
{
    ...
    public static class TenaIdentifiScaleExtensions
    {
        ...
        public static string ToReadableString(this TenaIdentifiScale unit)
        {
            switch (unit)
            {
                case TenaIdentifiScale.Toilet:             return "Toalettbesök med resultat";
                case TenaIdentifiScale.ToiletUnsuccessful: return "Toalettbesök utan resultat";
                case TenaIdentifiScale.Leakage:            return "Läckage utanför skyddet vid byte av skydd";
                case TenaIdentifiScale.Feces:              return "Avföring i skyddet vid byte av skydd";
