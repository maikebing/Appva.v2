            ...
            var menuLinks = new List<MenuLink>
                {
                    ...
                    new MenuLink(menus[HeaderMenu], "Boende", "List", "Patient", "Patient", 1, null, null, null, permissions[Permissions.PatientRead]),
                    new MenuLink(menus[HeaderMenu], "Medarbetare", "List", "Account", "Practitioner", 2, null, null, null, permissions[Permissions.AccountRead]),
                    new MenuLink(menus[HeaderMenu], "Roller och behörigheter", "List", "Roles", "Roles", 3, null, null, null, permissions[Permissions.NotificationRead]),
                    new MenuLink(menus[HeaderMenu], "Notiser", "List", "Notification", "Notification", 4, null, null, null, permissions[Permissions.NotificationRead]),
                    ...
                    new MenuLink(menus[PatientMenu], "Signeringslistor", "List", "Schedule", "Patient", 0, null, null, null, permissions[Permissions.PatientSchedulesRead]),
                    new MenuLink(menus[PatientMenu], "Signerade händelser", "Sign", "Schedule", "Patient", 1, null, null, null, permissions[Permissions.PatientSignedEventsRead]),
                    new MenuLink(menus[PatientMenu], "Larm", "List", "Alert", "Patient", 2, null, null, null, permissions[Permissions.PatientAlertsRead]),
                    new MenuLink(menus[PatientMenu], "Rapport", "ScheduleReport", "Schedule", "Patient", 3, null, null, null, permissions[Permissions.PatientReportsRead]),
                    new MenuLink(menus[PatientMenu], "Kalender", "List", "Calendar", "Patient", 4, null, null, null, permissions[Permissions.PatientCalendarRead]),
                    new MenuLink(menus[PatientMenu], "Saldon", "List", "Inventory", "Patient", 5, null, null, null, permissions[Permissions.PatientInventoryRead]),
