...
namespace Appva.Mcss.Admin.Domain.VO
{
    ...
    public sealed class SecurityTokenConfiguration : ValueObject<SecurityTokenConfiguration>
    {
        ...
        public static SecurityTokenConfiguration New(string issuer, string audience, TimeSpan registrationTokenLifetime, TimeSpan resetTokenLifetime)
        {
        ...
        /// <param name="audience">The audience</param>
        /// <returns>A new <see cref="SecurityTokenConfiguration"/> instance</returns>
        public static SecurityTokenConfiguration New(string issuer, string audience)
        {
            return New(issuer, audience, DefaultRegistrationTokenLifetime, DefaultResetTokenLifetime);
        }
        ...
        {
            yield return this.SigningKey;
            yield return this.Issuer;
            yield return this.Audience;
            yield return this.RegistrationTokenLifetime;
            yield return this.ResetTokenLifetime;
        }
