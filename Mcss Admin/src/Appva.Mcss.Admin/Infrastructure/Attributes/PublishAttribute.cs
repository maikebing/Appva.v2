...
namespace Appva.Mcss.Admin.Infrastructure.Attributes
{
    ...
    public class PublishAttribute : ActionFilterAttribute
    {
        ...
        public PublishAttribute(Type requestType)
        ...
        public PublishAttribute(string action, string controller)
        ...
        private PublishAttribute(Type requestType, string action, string controller, AttributeAction attributeAction)
        {
            this.Order = 1000;
        ...
        {
            //var modelType = request.GetType().GetInterfaces()[0];
            //var handlerType = typeof(INotification).M.MakeGenericType(request.GetType(), modelType);
            var handler = DependencyResolver.Current.GetService(request.GetType());
