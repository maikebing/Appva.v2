...
namespace Appva.Mcss.Admin.Areas.Patient.Features
{
    ...
    public sealed class TestCalendarController : IdentityController
    {
        ...
        public ActionResult List(ListTestCalendar request)
        {
            return View();
        }
        ...
        public ActionResult Create(Identity<CreateTestCalendar> request)
        {
            return View();
        }
        ...
        /// <returns></returns>
        [Route("create")]
        [HttpPost, Validate, ValidateAntiForgeryToken, Dispatch("list", "testcalendar")]
        [PermissionsAttribute(Permissions.Calendar.CreateValue)]
        public ActionResult Create(CreateTestCalendar request)
        {
            return View();
        }
        ...
        public ActionResult Edit(EditTestCalendar request)
        {
            return this.View();
        }
        ...
        /// <returns><see cref="ActionResult"/></returns>
        [Route("edit")]
        [HttpPost, MultiButton, Validate, ValidateAntiForgeryToken, Dispatch("List", "TestCalendar")]
        [PermissionsAttribute(Permissions.Calendar.UpdateValue)]
        public ActionResult Edit(TestEventViewModel request)
        {
            return View();
        }
        ...
        [PermissionsAttribute(Permissions.Calendar.UpdateValue)]
        public ActionResult EditThis(Guid id, Guid seqId, DateTime date, TestEventViewModel model)
        {
        ...
        [PermissionsAttribute(Permissions.Calendar.UpdateValue)]
        public ActionResult EditActivity(Guid id, Guid taskId, DateTime? date, TestEventViewModel model)
        {
            if (ModelState.IsValid)
            {
                var evt = this.context.Get<Task>(taskId);
        ...
        [Route("~/patient/testcalendar/overview")]
        [HttpGet, Dispatch]
        [PermissionsAttribute(Permissions.Dashboard.ReadCalendarValue)]
        public PartialViewResult Overview(OverviewTestCalendar request)
        {
        ...
        [Route("~/patient/testcalendar/quittance")]
        ...
        /// <param name="date">The date</param>
        /// <returns><see cref="JsonResult"/></returns>
        [Route("~/patient/testcalendar/unquittance")]
