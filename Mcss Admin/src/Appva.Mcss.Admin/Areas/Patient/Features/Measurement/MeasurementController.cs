...
namespace Appva.Mcss.Admin.Areas.Patient
{
    ...
    public sealed class MeasurementController : Controller
    {
        ...
        /// Lists the available observations.
        /// </summary>
        /// <param name="request">The request<see cref="TestMeasurement"/>.</param>
        /// <returns>ActionResult<see cref="TestMeasurementModel"/>.</returns>
        [Route("test")]
        [HttpGet, Dispatch]
        [PermissionsAttribute(Permissions.Patient.ReadValue)]
        public ActionResult Test(TestMeasurement request)
        {
            return this.View();
        }
