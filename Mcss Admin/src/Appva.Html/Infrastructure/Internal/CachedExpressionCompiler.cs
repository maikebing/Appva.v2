// <copyright file="CachedExpressionCompiler.cs" company="Appva AB">
...
namespace Appva.Html.Infrastructure.Internal
{
    ...
    public static class CachedExpressionCompiler
    {
        ...
        public static Func<TModel, TValue> Compile<TModel, TValue>(this Expression<Func<TModel, TValue>> lambdaExpression)
        {
            ...
            return InternalCachedExpressionCompiler.Process(lambdaExpression);
        }
        ...
        private static Func<object, object> Wrap(Expression arg)
        {
            ...
            return InternalCachedExpressionCompiler.Process(lambdaExpr);
        }
    }
    ...
    internal static class InternalCachedExpressionCompiler
    {
