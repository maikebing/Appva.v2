...
namespace Appva.Mcss.Admin.Configuration
{
    ...
    public static class ContainerBuilderExtensions
    {
        ...
        public static void RegisterGrandId(this ContainerBuilder builder)
        {
            ...
            builder.Register(x => new MobileGrandIdClient(options, new Uri(GrandIdConfiguration.ServerUrl), GrandIdCredentials.CreateNew(GrandIdConfiguration.MobileApiKey, GrandIdConfiguration.MobileAuthenticationServiceKey))).As<IMobileGrandIdClient>().SingleInstance();
        }
