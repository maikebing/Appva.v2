// <copyright file="DateGreaterThanOrEqualsAttribute.cs" company="Appva AB">
...
namespace Appva.Mvc
{
    ...
    public sealed class DateGreaterThanOrEqualsAttribute : ValidationAttribute, IClientValidatable
    {
